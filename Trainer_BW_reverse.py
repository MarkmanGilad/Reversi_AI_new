    ...
    for epoch in range(start_epoch, epochs):
        ...
        # Sample Environement
            ...
            if state_2: # not the first action in a game
                    buffer_B.push(state_2_R, action_2_R, reward_1_R, after_state_1_R, end_of_game_1_R)    # for black
            if end_of_game_1:
                res += reward_1
                buffer_W.push(state_1, action_1, reward_1, after_state_1, True) # for white
                ...
                if end_of_game_2:
                    res += reward_2
                    buffer_B.push(state_2_R, action_2_R, reward_2_R, after_state_2_R, True) # for black
